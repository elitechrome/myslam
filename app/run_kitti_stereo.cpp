...
//    cv::Mat img = cv::imread("/home/jaemin/a.bmp");
    BMP bmp("/mnt/nas/a.bmp");
    std::chrono::duration<double> sec = std::chrono::system_clock::now() - start;
    std::cout << "width: " << bmp.bmp_info_header.width << ", height: " << bmp.bmp_info_header.height << " processing: " << sec.count() << " seconds" << std::endl;
    cv::Mat img (bmp.bmp_info_header.height, bmp.bmp_info_header.width, CV_8UC3, bmp.data.data());
